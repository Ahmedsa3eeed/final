...
for model in models:
    ...
    scores = cross_validate(estimator = pl , X = x , y = y2 , cv = StratifiedKFold(n_splits=5) ,
...
scores = cross_validate(estimator = model1 , X = x , y = y2 , cv = StratifiedKFold(n_splits=5) ,
                scoring='accuracy' , return_train_score=True )
...
scores = cross_validate(estimator = pl4 , X = x , y = y2 , cv = StratifiedKFold(n_splits=5) ,
                scoring='accuracy' , return_train_score=True )
...
scores = cross_validate(estimator = model , X = x , y = y2 , cv = StratifiedKFold(n_splits=5) ,
                scoring='accuracy' , return_train_score=True )
print(scores['train_score'].mean())
print(scores['test_score'].mean())
